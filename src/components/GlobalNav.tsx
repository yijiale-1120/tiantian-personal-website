  ...
  return (
    <nav className="glass-nav mb-20 flex items-center justify-between font-mono px-6 md:px-12 lg:px-24 xl:px-32">
      ...
      <div className="flex gap-3 text-sm font-bold uppercase tracking-widest">
        <Link
          to="/"
          className="px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-slate-200 text-slate-700 hover:bg-sky-500 hover:text-white transition-all btn-hover-scale"
        >
          Home
        </Link>
        <Link
